 ...
 * <p>
 * This class manages BungeeCord spoofing settings, including the username, UUID, IP addresses, and token. It
 * initializes with values from the Minecraft session and provides methods to modify these values.
 * </p>
 *
 * @author SpigotRCE
 * @since 1.0
