...
import static net.md_5.bungee.protocol.packet.PluginMessage.*;

@Mixin(value = PluginMessage.class, remap = false) public class PluginMessageMixin {
   ...
   */
  @Overwrite public void read(ByteBuf buf, ProtocolConstants.Direction direction, int protocolVersion) {
