 ...
 *
 * <p>
 * This class manages the Discord Rich Presence integration, allowing the mod to display the player's current status and
 * activity in Discord.
 * </p>
 *
 * @author 1nstagram
...
public class RichPresenceUpdater {
  ...
  public RichPresenceUpdater() {
    richPresence = new DiscordRichPresence.Builder("").setBigImage("af9df3fa19b7374e5e7582865f9fb1e7", "ParadiseClient")
   ...
   */
  public void updatePresence(String playerName,
